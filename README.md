...
| `/asvs-compliance` | Full ASVS 5.0 compliance matrix (346 controls) — COMPLIANT/NON_COMPLIANT/NOT_RELEVANT per control with code evidence, outputs CSV + HTML report |
</details>
