...
description: >-
  ...
  Use when the user asks for a cloud security audit, AWS/Azure/GCP pentest, IAM privesc check, S3/blob/GCS exposure scan, IMDS/metadata exploitation, serverless attack-surface review, or compliance audit (SOC 2, PCI DSS, HIPAA, CIS) of a cloud account.
