...
description: >-
  ...
  Use to investigate a CVE, check whether a dependency vulnerability is exploitable in this codebase, trace a known exploit's code path through the project, or generate a Burp Repeater PoC for a CVE.
