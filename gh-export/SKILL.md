...
description: >-
  ...
  Use to file pentest findings as GitHub issues, export a pentest report into an issue tracker, generate copy-paste-ready issue templates from `findings.json`, or hand off scan output to a remediation workflow.
