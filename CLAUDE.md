...
| `pentest/findings.json` | Derived snapshot: confirmed vulnerabilities, current state | Regenerated by `Bash("uv run python ~/.claude/skills/pentester/refresh.py")`. **Read-only for skills.** |
